        ...
        try {
            ...
            while (start) {
                try {
                    ...
                    System.out.println("ACCEPT " + ip + " current=" + number);
                    java.nio.file.Files.writeString(java.nio.file.Path.of("/app/session-debug.log"), "ACCEPT " + ip + " current=" + number + "\n", java.nio.file.StandardOpenOption.CREATE, java.nio.file.StandardOpenOption.APPEND);
                    if (number >= Config.getInstance().getIpAddressLimit()) {
                        System.out.println("REJECT " + ip + " limit=" + Config.getInstance().getIpAddressLimit());
                        java.nio.file.Files.writeString(java.nio.file.Path.of("/app/session-debug.log"), "REJECT " + ip + " limit=" + Config.getInstance().getIpAddressLimit() + "\n", java.nio.file.StandardOpenOption.CREATE, java.nio.file.StandardOpenOption.APPEND);
                        client.close();
                        continue;
                    }
                    ...
                    System.out.println("SESSION " + cl.id + " " + ip + " created");
                    java.nio.file.Files.writeString(java.nio.file.Path.of("/app/session-debug.log"), "SESSION " + cl.id + " " + ip + " created\n", java.nio.file.StandardOpenOption.CREATE, java.nio.file.StandardOpenOption.APPEND);
                } catch (Exception e) {
                    e.printStackTrace();
                    try {
                        java.nio.file.Files.writeString(java.nio.file.Path.of("/app/session-debug.log"), "ACCEPT_ERROR " + e.getClass().getName() + " " + e.getMessage() + "\n", java.nio.file.StandardOpenOption.CREATE, java.nio.file.StandardOpenOption.APPEND);
