    ...
    class MessageCollector implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                System.out.println("SESSION " + id + " reader error: " + ex.getClass().getName() + " - " + ex.getMessage());
                ex.printStackTrace();
                try {
                    java.nio.file.Files.writeString(java.nio.file.Path.of("/app/session-debug.log"), "SESSION " + id + " reader error: " + ex.getClass().getName() + " - " + ex.getMessage() + "\n", java.nio.file.StandardOpenOption.CREATE, java.nio.file.StandardOpenOption.APPEND);
                } catch (Exception ignored) {
                }
            }
            System.out.println("SESSION " + id + " closeMessage");
            try {
                java.nio.file.Files.writeString(java.nio.file.Path.of("/app/session-debug.log"), "SESSION " + id + " closeMessage\n", java.nio.file.StandardOpenOption.CREATE, java.nio.file.StandardOpenOption.APPEND);
            } catch (Exception ignored) {
            }
            closeMessage();
        }
        ...
        private Message readMessage() throws Exception {
            try {
                ...
                System.out.println("SESSION " + id + " read cmd=" + cmd + " size=" + size + " keyed=" + sendKeyComplete);
                java.nio.file.Files.writeString(java.nio.file.Path.of("/app/session-debug.log"), "SESSION " + id + " read cmd=" + cmd + " size=" + size + " keyed=" + sendKeyComplete + "\n", java.nio.file.StandardOpenOption.CREATE, java.nio.file.StandardOpenOption.APPEND);
